#!/usr/bin/env python3
"""
End-to-end integration test for endpoint
"""
import requests
from app import AUTH

# connects to the local machine server
BASE_URL = "http://localhost:5000"

def register_user(email: str, password: str) -> None:
    """
    Tests for user's registration
    """
    # Adds users' path base url
...
def log_in_wrong_password(email: str, password: str) -> None:
    """Tests users logging in with wrong password.
    Args:
